...
import glob, os, subprocess, sys, time, libtbx.easy_run
...
'''
(cryo_fit_path,bool_missing,bool_ignh)=("","","")
def make_gro_top(input_pdb_file_name, force_field, *args):
  ...
  input_pdb_file_name_without_folder = os.path.basename(input_pdb_file_name)
